...
def generate_podcast_api():
    try:
        ...
        if urls:
            ...
            audio_file = generate_podcast(transcript_file=transcript_file, tts_model=tts_model, transcript_only=transcript_only,api_key_label=api_key_label)

        elif file_path:
            audio_file = generate_podcast(url_file=file_path, tts_model=tts_model, api_key_label=api_key_label)
